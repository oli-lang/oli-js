...
isDate = function(obj){
  return deepEq$(toS(obj), '[object Date]', '===');
};
isRegExp = function(obj){
  return deepEq$(toS(obj), '[object RegExp]', '===');
};
isError = function(obj){
  return deepEq$(toS(obj), '[object Error]', '===');
};
isBoolean = function(obj){
  return deepEq$(toS(obj), '[object Boolean]', '===');
};
isNumber = function(obj){
  return deepEq$(toS(obj), '[object Number]', '===');
};
isString = function(obj){
  return deepEq$(toS(obj), '[object String]', '===');
};
