module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c91 = function() { return astNode({ type: "BooleanLiteral", value: true  }) },
        peg$c92 = function() { return astNode({ type: "BooleanLiteral", value: false }) },
        ...
        peg$c99 = function(parts) { return parts; },
        ...
        peg$c113 = function(digits) { return parseInt(digits, 16); },
        peg$c114 = /^[0-9a-fA-F]/,
        peg$c115 = { type: "class", value: "[0-9a-fA-F]", description: "[0-9a-fA-F]" },
        peg$c116 = { type: "other", description: "quoted string" },
        peg$c117 = "\"",
        peg$c118 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c119 = "'",
        peg$c120 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c121 = function(parts) {
              return astNode({
                type:  'StringLiteral',
                value: parts[1],
                raw:   parts.join('')
        ...
        peg$c126 = /^['"\\bfnrtv]/,
        peg$c127 = { type: "class", value: "['\"\\\\bfnrtv]", description: "['\"\\\\bfnrtv]" },
        peg$c128 = function(char_) {
              return char_
                .replace("b", "\b")
                .replace("f", "\f")
                .replace("n", "\n")
        ...
        peg$c129 = function(char_) { return char_; },
        peg$c130 = "x",
        ...
        peg$c144 = "yes",
        peg$c145 = { type: "literal", value: "yes", description: "\"yes\"" },
        peg$c146 = "false",
        peg$c147 = { type: "literal", value: "false", description: "\"false\"" },
        peg$c148 = "no",
        peg$c149 = { type: "literal", value: "no", description: "\"no\"" },
        peg$c150 = { type: "other", description: "end of block" },
        peg$c151 = "end",
    ...
    function peg$parseUnquotedLiteralInLine() {
      var s0, s1, s2, s3;
    ...
    function peg$parseIdentifierExpression() {
      ...
      if (s1 !== peg$FAILED) {
        s2 = peg$parse__();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseIdentifierOperationExpression();
          if (s3 === peg$FAILED) {
            s3 = peg$c2;
          }
          if (s3 !== peg$FAILED) {
            s4 = peg$parse__();
            if (s4 !== peg$FAILED) {
              s5 = peg$parseIdentifierArrowExpression();
              if (s5 === peg$FAILED) {
                s5 = peg$c2;
              }
              if (s5 !== peg$FAILED) {
    ...
    function peg$parseListExpression() {
      ...
      if (s1 !== peg$FAILED) {
        s2 = peg$parse__();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseListElementExpression();
          if (s3 !== peg$FAILED) {
            s1 = [s1, s2, s3];
            s0 = s1;
          } else {
    ...
    function peg$parseBlockElements() {
      var s0, s1, s2, s3;
    ...
    function peg$parseBlockElementsInLine() {
      var s0, s1, s2, s3;
            ...
            if (s4 !== peg$FAILED) {
              ...
              if (s5 !== peg$FAILED) {
                ...
                if (s6 !== peg$FAILED) {
                  ...
                  if (s7 === peg$FAILED) {
                    s7 = peg$parseBlockElementsInLine();
                  }
                  if (s7 !== peg$FAILED) {
                    s8 = peg$parse_();
                    if (s8 !== peg$FAILED) {
