module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c14 = function(line, children) {
              var o = {};
              o[line] = children;
        ...
        peg$c17 = function(i) { return i.join('') === indent; },
        peg$c18 = function(i) { return i.length > indent.length; },
        peg$c19 = function(i) {
              indentStack.push(indent);
              indent = i.join('');
              pos = offset;
            },
        peg$c20 = function() { indent = indentStack.pop(); },
        peg$c21 = ",",
        ...
        peg$c48 = { type: "other", description: "unquoted string" },
        peg$c49 = "-",
        ...
        peg$c55 = /^[\-._$!]/,
        peg$c56 = { type: "class", value: "[\\-._$!]", description: "[\\-._$!]" },
        peg$c57 = "$",
        ...
        peg$c71 = function(operator, expression) {
              return {
        ...
        peg$c100 = function(attrs) {
            return attrs !== null ? attrs : null;
          },
        peg$c101 = function(id, operation, ref, attrs) {
            var node;
            switch (id.type) {
        ...
        peg$c103 = function(elements) {
            return astNode({
              type:  'ListExpression',
              elements: elements !== null ? elements : []
            })
          },
        peg$c104 = function() { return astNode({ type: "BooleanLiteral", value: true  }) },
        peg$c105 = function() { return astNode({ type: "BooleanLiteral", value: false }) },
        peg$c106 = { type: "other", description: "number" },
        peg$c107 = function(number) {
            return number;
          },
        ...
        peg$c112 = function(parts) { return parts; },
        peg$c113 = function(number) {
              return astNode({
                type:  'DecimalLiteral',
        ...
        peg$c124 = /^[xX]/,
        peg$c125 = { type: "class", value: "[xX]", description: "[xX]" },
        peg$c126 = function(digits) { return parseInt(digits, 16); },
        peg$c127 = /^[0-9a-fA-F]/,
        peg$c128 = { type: "class", value: "[0-9a-fA-F]", description: "[0-9a-fA-F]" },
        peg$c129 = { type: "other", description: "quoted string" },
        peg$c130 = "\"",
        peg$c131 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c132 = "'",
        peg$c133 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c134 = function(parts) {
              return astNode({
                type:  'StringLiteral',
                value: parts[1],
                raw:   parts.join('')
        ...
        peg$c136 = function(char_) { return char_;     },
        peg$c137 = function(sequence) { return sequence;  },
        peg$c138 = function() { return "\0"; },
        peg$c139 = /^['"\\bfnrtv]/,
        peg$c140 = { type: "class", value: "['\"\\\\bfnrtv]", description: "['\"\\\\bfnrtv]" },
        peg$c141 = function(char_) {
              return char_
                .replace("b", "\b")
                .replace("f", "\f")
                .replace("n", "\n")
    ...
    function peg$parseUnquotedStringLiteral() {
      ...
      if (s1 !== peg$FAILED) {
        ...
        if (s2 !== peg$FAILED) {
          ...
          if (s3 !== peg$FAILED) {
            s4 = [];
            s5 = peg$parseLiteralSequenceCharacters();
            if (s5 !== peg$FAILED) {
              while (s5 !== peg$FAILED) {
                s4.push(s5);
                s5 = peg$parseLiteralSequenceCharacters();
              ...
              if (s7 !== peg$FAILED) {
                ...
                if (s8 !== peg$FAILED) {
                  ...
                  if (s9 !== peg$FAILED) {
                    s10 = peg$parse__();
                    if (s10 !== peg$FAILED) {
                      s11 = peg$parsePrimitiveValueExpression();
                      if (s11 !== peg$FAILED) {
                        peg$reportedPos = s6;
                        s7 = peg$c153(s7, s11);
                        s6 = s7;
