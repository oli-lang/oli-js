module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c89 = function(attrs) {
            return attrs !== null ? attrs : null;
          },
        peg$c90 = function(id, operation, ref, attrs) {
            var node;
            switch (id.type) {
        ...
        peg$c93 = function() { return astNode({ type: "BooleanLiteral", value: true  }) },
        peg$c94 = function() { return astNode({ type: "BooleanLiteral", value: false }) },
        ...
        peg$c101 = function(parts) { return parts; },
        peg$c102 = function(number) {
              return astNode({
                type:  'DecimalLiteral',
        ...
        peg$c115 = function(digits) { return parseInt(digits, 16); },
        peg$c116 = /^[0-9a-fA-F]/,
        peg$c117 = { type: "class", value: "[0-9a-fA-F]", description: "[0-9a-fA-F]" },
        peg$c118 = { type: "other", description: "quoted string" },
        peg$c119 = "\"",
        peg$c120 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c121 = "'",
        peg$c122 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c123 = function(parts) {
              return astNode({
                type:  'StringLiteral',
                value: parts[1],
                raw:   parts.join(''),
        ...
        peg$c128 = /^['"\\bfnrtv]/,
        peg$c129 = { type: "class", value: "['\"\\\\bfnrtv]", description: "['\"\\\\bfnrtv]" },
        peg$c130 = function(char_) {
              return char_
                .replace("b", "\b")
                .replace("f", "\f")
                .replace("n", "\n")
        ...
        peg$c131 = function(char_) { return char_; },
        peg$c132 = "x",
        ...
        peg$c143 = "yes",
        peg$c144 = { type: "literal", value: "yes", description: "\"yes\"" },
        peg$c145 = "false",
        peg$c146 = { type: "literal", value: "false", description: "\"false\"" },
        peg$c147 = "no",
        peg$c148 = { type: "literal", value: "no", description: "\"no\"" },
        peg$c149 = { type: "other", description: "end of block" },
        peg$c150 = "end",
        peg$c151 = { type: "literal", value: "end", description: "\"end\"" },
        peg$c152 = ":>",
    ...
    function peg$parseBlockStatementList() {
      var s0, s1, s2, s3, s4, s5, s6, s7;
    ...
    function peg$parseCopyStatement() {
      ...
      if (s1 !== peg$FAILED) {
        s2 = peg$parse__();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseCopyToken();
          if (s3 !== peg$FAILED) {
            s4 = peg$parse__();
            if (s4 !== peg$FAILED) {
              s5 = peg$parseIdentifierExpression();
              if (s5 !== peg$FAILED) {
                s6 = peg$parse__();
                if (s6 !== peg$FAILED) {
                  s7 = peg$parse__();
      ...
      if (s1 !== peg$FAILED) {
        ...
        if (s2 !== peg$FAILED) {
          ...
          if (s3 !== peg$FAILED) {
            s4 = peg$parse__();
            if (s4 !== peg$FAILED) {
              s5 = peg$parseBlockStatementList();
              if (s5 !== peg$FAILED) {
                s6 = peg$parse__();
                if (s6 !== peg$FAILED) {
    ...
    function peg$parseCopyToken() {
      ...
      s0 = peg$currPos;
      s1 = peg$parseCopyAssignmentOperator();
      if (s1 !== peg$FAILED) {
        s2 = peg$currPos;
        peg$silentFails++;
        s3 = peg$parseIdentifierPart();
    ...
    function peg$parseCopyAssignmentOperator() {
      var s0;
    ...
    function peg$parseCopyOperator() {
      var s0;
    ...
    function peg$parseValueAssigmentOperator() {
      var s0;
