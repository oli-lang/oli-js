module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c63 = { type: "other", description: "literal" },
        peg$c64 = /^[0-9a-zA-ZsS\tT\rR]/,
        peg$c65 = { type: "class", value: "[0-9a-zA-ZsS\\tT\\rR]", description: "[0-9a-zA-ZsS\\tT\\rR]" },
        peg$c66 = { type: "other", description: "literal sequence" },
        peg$c67 = /^[a-zA-Z0-9\-_.]/,
        peg$c68 = { type: "class", value: "[a-zA-Z0-9\\-_.]", description: "[a-zA-Z0-9\\-_.]" },
        peg$c69 = function(letters) {
        		return letters.join("");
        	},
        ...
        peg$c103 = /^[xX]/,
        peg$c104 = { type: "class", value: "[xX]", description: "[xX]" },
        peg$c105 = function(digits) { return parseInt(digits, 16); },
        peg$c106 = /^[0-9a-fA-F]/,
        ...
        peg$c112 = "yes",
        peg$c113 = { type: "literal", value: "yes", description: "\"yes\"" },
        peg$c114 = "false",
        peg$c115 = { type: "literal", value: "false", description: "\"false\"" },
        peg$c116 = "no",
        peg$c117 = { type: "literal", value: "no", description: "\"no\"" },
        peg$c118 = { type: "other", description: "end of block" },
        peg$c119 = "end",
        peg$c120 = { type: "literal", value: "end", description: "\"end\"" },
        ...
        peg$c132 = function(lit) {
            var string = '';
            for (var k = 0; k < lit.length; k += 1) {
              string += lit[k].name
            }
            return string
          },
        ...
        peg$c146 = function(id, ref, value) {
            return astNode({
              type:     "ValueAssignmentExpression",
              id:       id,
              ref:      ref,
              value:    value
            })
          },
        peg$c147 = function(keyword, name, statements) {
              return astNode({
    ...
    function peg$parseLiteralSequence() {
      var s0, s1, s2;
    ...
    function peg$parseUnquotedLiteralSentence() {
      var s0, s1, s2, s3;
      ...
      if (s1 === peg$FAILED) {
        ...
        if (s1 === peg$FAILED) {
          ...
          if (s1 === peg$FAILED) {
            ...
            if (s1 === peg$FAILED) {
              s1 = peg$parseUnquotedLiteralSentence();
            }
          }
        }
      }
    ...
    function peg$parseValueAssignmentExpression() {
    ...
    function peg$parseTypeDeclaration() {
      ...
      s0 = peg$parseValueAssignmentExpression();
      if (s0 === peg$FAILED) {
        s0 = peg$parseComment();
        if (s0 === peg$FAILED) {
    ...
    function peg$parseBlockDeclaration() {
      var s0, s1;
