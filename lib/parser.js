module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c88 = function(id, expression, attrs) {
            return astNode({
        ...
        peg$c89 = function(elements) { return elements; },
        ...
        peg$c135 = function(operator) {
            return Array.isArray(operator) ? operator.join('') : operator;
          },
        peg$c136 = function(id, operator) {
              return astNode({
        ...
        peg$c137 = function(body) { return body; },
        ...
        peg$c139 = function(operator, body) {
            return astNode({
              type:     'PipeStatement',
              operator: operator,
              body:     body !== null ? body : []
        ...
        peg$c140 = function(id, operator, head, tail) {
              var body = [ head ];
              for (var i = 0, l = tail.length; i < l; i+=1) {
                body.push(tail[i][1]);
              }
        ...
        peg$c141 = function(id, operator, body) {
              return astNode({
                type:    'ExpressionStatement',
                expression: astNode({
                  type:     'BlockStatement',
