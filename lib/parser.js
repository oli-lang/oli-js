module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c3 = /^[ \xA0\u1680\u180E\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000]/,
        peg$c4 = { type: "class", value: "[ \\xA0\\u1680\\u180E\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200A\\u202F\\u205F\\u3000]", description: "[ \\xA0\\u1680\\u180E\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200A\\u202F\\u205F\\u3000]" },
        peg$c5 = { type: "other", description: "whitespace" },
        peg$c6 = /^[\t\x0B\f \xA0\uFEFF]/,
        peg$c7 = { type: "class", value: "[\\t\\x0B\\f \\xA0\\uFEFF]", description: "[\\t\\x0B\\f \\xA0\\uFEFF]" },
        peg$c8 = [],
        peg$c9 = void 0,
        ...
        peg$c21 = { type: "other", description: "end of line" },
        peg$c22 = "\n",
        ...
        peg$c37 = { type: "other", description: "quoted string" },
        peg$c38 = "\"",
        peg$c39 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c40 = "'",
        peg$c41 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c42 = function(parts) {
              return astNode({
                type:  'StringLiteral',
                value: parts[1],
                raw:   parts.join('')
        ...
        peg$c46 = function(char_) { return char_;     },
        ...
        peg$c52 = /^['"\\bfnrtv]/,
        peg$c53 = { type: "class", value: "['\"\\\\bfnrtv]", description: "['\"\\\\bfnrtv]" },
        peg$c54 = function(char_) {
              return char_
                .replace("b", "\b")
                .replace("f", "\f")
                .replace("n", "\n")
        ...
        peg$c56 = "x",
        peg$c57 = { type: "literal", value: "x", description: "\"x\"" },
        peg$c58 = "u",
        ...
        peg$c63 = function(char) { return char; },
        peg$c64 = { type: "other", description: "unquoted string" },
        ...
        peg$c66 = /^[a-zA-Z0-9\-_.]/,
        peg$c67 = { type: "class", value: "[a-zA-Z0-9\\-_.]", description: "[a-zA-Z0-9\\-_.]" },
        ...
        peg$c84 = function() { return astNode({ type: "BooleanLiteral", value: true  }) },
        peg$c85 = function() { return astNode({ type: "BooleanLiteral", value: false }) },
        peg$c86 = { type: "other", description: "number" },
        peg$c87 = function(number) {
            return number;
          },
        ...
        peg$c91 = function(parts) {
              return parts;
            },
        peg$c92 = function(parts) { return parts; },
        ...
        peg$c104 = function(digits) { return parseInt(digits, 16); },
        peg$c105 = /^[0-9a-fA-F]/,
        peg$c106 = { type: "class", value: "[0-9a-fA-F]", description: "[0-9a-fA-F]" },
        peg$c107 = function(operator) {
              return {
        ...
        peg$c112 = function(operator, expression) {
              return {
        ...
        peg$c130 = function(operator) { return operator; },
        ...
        peg$c147 = "yes",
        peg$c148 = { type: "literal", value: "yes", description: "\"yes\"" },
        peg$c149 = "false",
        peg$c150 = { type: "literal", value: "false", description: "\"false\"" },
        peg$c151 = "no",
        peg$c152 = { type: "literal", value: "no", description: "\"no\"" },
        peg$c153 = { type: "other", description: "end of block" },
        peg$c154 = "end",
        peg$c155 = { type: "literal", value: "end", description: "\"end\"" },
        peg$c156 = function(id, extend) {
            return astNode({
              type: 'ValueIdentifierExpression',
              id: id,
              extend: extend
            })
          },
        peg$c157 = function(id) {
            return astNode({
              type:   'ValueIdentifierAlias',
              id:     id
            })
          },
        peg$c158 = ">>",
        peg$c159 = { type: "literal", value: ">>", description: "\">>\"" },
        peg$c160 = function(id) {
            return astNode({
              type:   'ValueCloneExpression',
              id:     id
            })
          },
        peg$c161 = ">>>",
        peg$c162 = { type: "literal", value: ">>>", description: "\">>>\"" },
        peg$c163 = function(id) {
            return astNode({
              type:   'ValueMergeExpression',
              id:     id
            })
          },
        ...
        peg$c176 = function(items) {
            return items !== null ? items : [];
          },
        peg$c177 = function(id, ref, value) {
            return astNode({
        ...
        peg$c178 = function(keyword, name, body) {
              return astNode({
                type:     "BlockStatement",
                name:     name,
                keyword:  keyword,
    ...
    function peg$parseUnquotedStringLiteral() {
      ...
      s0 = peg$currPos;
      s1 = [];
      s2 = peg$parseLiteralSequenceCharacters();
      if (s2 !== peg$FAILED) {
        while (s2 !== peg$FAILED) {
          s1.push(s2);
          s2 = peg$parseLiteralSequenceCharacters();
    ...
    function peg$parseValueIdentifierExpression() {
      var s0, s1, s2, s3;

      s0 = peg$currPos;
      s1 = peg$parseValueIdentifierAlias();
      if (s1 !== peg$FAILED) {
        s2 = peg$parse__();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseValueCloneExpression();
          if (s3 === peg$FAILED) {
            s3 = peg$parseValueMergeExpression();
          }
          if (s3 !== peg$FAILED) {
            peg$reportedPos = s0;
            s1 = peg$c156(s1, s3);
    ...
    function peg$parseValueIdentifierAlias() {
      var s0, s1, s2, s3;
    ...
    function peg$parseValueCloneExpression() {
      var s0, s1, s2, s3;
    ...
    function peg$parseValueMergeExpression() {
      var s0, s1, s2, s3;
    ...
    function peg$parseValueAssignmentStatement() {
      ...
      if (s1 !== peg$FAILED) {
        s2 = peg$parse__();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseValueIdentifierExpression();
          if (s3 === peg$FAILED) {
            s3 = peg$c11;
          }
          if (s3 !== peg$FAILED) {
