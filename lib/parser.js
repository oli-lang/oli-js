module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c67 = function(char) { return char; },
        peg$c68 = { type: "other", description: "unquoted string" },
        peg$c69 = "-",
        ...
        peg$c118 = function(operator, expression) {
              return {
        ...
        peg$c134 = function(operator) { return operator; },
        ...
        peg$c172 = function(id) {
            return astNode({
              type: 'IdentifierReferenceExpression',
              name: id
            })
          },
        peg$c173 = function(id, operation, ref) {
        ...
        peg$c178 = function(elements) {
            return astNode({
              type:  'ListExpression',
              elements: elements !== null ? elements : []
            })
          },
        peg$c179 = function(id, value) {
            return astNode({
        ...
        peg$c181 = function(element) {
            return element
          },
        peg$c182 = function(value) { return value; },
        peg$c183 = function(head, value) {
              var result = [ head ];
      ...
      if (s1 !== peg$FAILED) {
        ...
        if (s2 !== peg$FAILED) {
          ...
          if (s3 !== peg$FAILED) {
            s4 = peg$parse__();
            if (s4 !== peg$FAILED) {
              s5 = peg$parseListElementsExpressions();
              if (s5 !== peg$FAILED) {
                s6 = peg$parse__();
                if (s6 !== peg$FAILED) {
                  s7 = peg$parseEOS();
