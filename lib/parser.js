module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c10 = /^[a-zA-Z0-9\-\\\/\\_\^|\xBA\xA8\xE7\xA1\xBF.$@?%+;]/,
        peg$c11 = { type: "class", value: "[a-zA-Z0-9\\-\\\\\\/\\\\_\\^|\\xBA\\xA8\\xE7\\xA1\\xBF.$@?%+;]", description: "[a-zA-Z0-9\\-\\\\\\/\\\\_\\^|\\xBA\\xA8\\xE7\\xA1\\xBF.$@?%+;]" },
        peg$c12 = ",",
        ...
        peg$c40 = { type: "other", description: "unquoted literal" },
        peg$c41 = "-",
        ...
        peg$c47 = { type: "other", description: "reference" },
        peg$c48 = /^[\-._$!]/,
        ...
        peg$c62 = function(operator, expression) {
              return {
        ...
        peg$c85 = function(attrs) {
            return attrs !== null ? attrs : null;
          },
        peg$c86 = function(id, operation, ref, attrs) {
            var node;
            switch (id.type) {
        ...
        peg$c87 = function(elements) { return elements; },
        peg$c88 = function(elements) {
            return astNode({
              type:  'ListExpression',
              elements: elements !== null ? elements : []
            })
          },
        peg$c89 = function() { return astNode({ type: "BooleanLiteral", value: true  }) },
        peg$c90 = function() { return astNode({ type: "BooleanLiteral", value: false }) },
        peg$c91 = { type: "other", description: "number" },
        peg$c92 = function(number) {
            return number;
          },
        peg$c93 = function(number) {
              return astNode({
                type:   'IntegerLiteral',
        ...
        peg$c96 = function(parts) {
              return parts;
            },
        peg$c97 = function(parts) { return parts; },
        ...
        peg$c99 = "0",
        peg$c100 = { type: "literal", value: "0", description: "\"0\"" },
        peg$c101 = /^[0-9]/,
        ...
        peg$c109 = /^[xX]/,
        peg$c110 = { type: "class", value: "[xX]", description: "[xX]" },
        peg$c111 = function(digits) { return parseInt(digits, 16); },
        peg$c112 = /^[0-9a-fA-F]/,
        peg$c113 = { type: "class", value: "[0-9a-fA-F]", description: "[0-9a-fA-F]" },
        peg$c114 = { type: "other", description: "quoted string" },
        peg$c115 = "\"",
        ...
        peg$c121 = function(char_) { return char_;     },
        peg$c122 = function(sequence) { return sequence;  },
        peg$c123 = function() { return "\0"; },
        peg$c124 = /^['"\\bfnrtv]/,
        peg$c125 = { type: "class", value: "['\"\\\\bfnrtv]", description: "['\"\\\\bfnrtv]" },
        peg$c126 = function(char_) {
              return char_
                .replace("b", "\b")
                .replace("f", "\f")
                .replace("n", "\n")
    ...
    function peg$parseLiteralReservedTokens() {
      ...
      if (s0 === peg$FAILED) {
        s0 = peg$parseReferenceNotOperator();
        if (s0 === peg$FAILED) {
    ...
    function peg$parseIdentifierNameExpression() {
      ...
      s0 = peg$parseIdentifierReferenceNegationExpression();
      if (s0 === peg$FAILED) {
    ...
    function peg$parseIdentifierOperationExpression() {
      ...
      s0 = peg$parseIdentifierMergeExpression();
      if (s0 === peg$FAILED) {
        s0 = peg$parseIdentifierCloneExpression();
      }

      return s0;
    }

    function peg$parseIdentifierArrowExpression() {
      var s0;

      s0 = peg$parseIdentifierArrowNegationReferenceExpression();
      if (s0 === peg$FAILED) {
        s0 = peg$parseIdentifierArrowReferenceExpression();
      }
    ...
    function peg$parseIdentifierArrowNegationReferenceExpression() {
      var s0, s1, s2, s3;

      s0 = peg$currPos;
      s1 = peg$parseReferenceNotOperator();
      if (s1 !== peg$FAILED) {
        s2 = peg$parse__();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseIdentifierLiteralExpression();
    ...
    function peg$parseIdentifierMergeExpression() {
      var s0, s1, s2, s3;
    ...
    function peg$parseIdentifierReferenceNegationExpression() {
      var s0, s1, s2, s3, s4;

      s0 = peg$currPos;
      s1 = peg$parseLogicalNotOperator();
      if (s1 !== peg$FAILED) {
        s2 = peg$parseAnchorOperator();
        if (s2 !== peg$FAILED) {
          s3 = peg$parse__();
          if (s3 !== peg$FAILED) {
            s4 = peg$parseIdentifierLiteralExpression();
            if (s4 !== peg$FAILED) {
              peg$reportedPos = s0;
              s1 = peg$c77(s4);
              s0 = s1;
    ...
    function peg$parseAttributeAssignmentExpression() {
      var s0, s1, s2, s3, s4, s5, s6;
        ...
        if (s2 !== peg$FAILED) {
          ...
          if (s4 !== peg$FAILED) {
            ...
            if (s5 !== peg$FAILED) {
              ...
              if (s6 === peg$FAILED) {
                s6 = peg$parseIdentifierNameExpression();
              }
              if (s6 !== peg$FAILED) {
                peg$reportedPos = s3;
                s4 = peg$c78(s6);
    ...
    function peg$parseIdentifierAttributesList() {
      ...
      s0 = peg$currPos;
      s1 = peg$parseAttributeAssignmentExpression();
      if (s1 !== peg$FAILED) {
        s2 = [];
        s3 = peg$currPos;
        s4 = peg$parse__();
        if (s4 !== peg$FAILED) {
          ...
          if (s5 !== peg$FAILED) {
            s6 = peg$parse__();
            if (s6 !== peg$FAILED) {
              s7 = peg$parseAttributeAssignmentExpression();
              if (s7 !== peg$FAILED) {
                s4 = [s4, s5, s6, s7];
                s3 = s4;
              } else {
          ...
          if (s3 !== peg$FAILED) {
            ...
            if (s4 !== peg$FAILED) {
              ...
              if (s5 !== peg$FAILED) {
                s6 = peg$parse__();
                if (s6 !== peg$FAILED) {
                  s7 = peg$parseIdentifierArrowExpression();
                  if (s7 === peg$FAILED) {
                    s7 = peg$c2;
                  }
                  if (s7 !== peg$FAILED) {
                    s8 = peg$parse__();
                    if (s8 !== peg$FAILED) {
                      s9 = peg$parseIdentifierAttributesExpression();
                      if (s9 === peg$FAILED) {
                        s9 = peg$c2;
                      }
                      if (s9 !== peg$FAILED) {
    ...
    function peg$parseMainStatement() {
      ...
      s0 = peg$parseComment();
      if (s0 === peg$FAILED) {
        s0 = peg$parseValueBlockStatement();
        if (s0 === peg$FAILED) {
    ...
    function peg$parseBlockAsignmentOperator() {
      ...
      if (s1 === peg$FAILED) {
        s1 = peg$parseDeclarationAssignOperator();
        if (s1 === peg$FAILED) {
    ...
    function peg$parseValueBlockStatement() {
    ...
    function peg$parseDeclarationAssignOperator() {
      var s0;
    ...
    function peg$parseReferenceNotOperator() {
      var s0;
