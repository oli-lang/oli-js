module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c12 = function(line, children) {
              var o = {};
              o[line] = children;
        ...
        peg$c15 = function(i) { return i.join('') === indent; },
        peg$c16 = function(i) { return i.length > indent.length; },
        peg$c17 = function(i) {
              indentStack.push(indent);
              indent = i.join('');
              pos = offset;
            },
        peg$c18 = function() { indent = indentStack.pop(); },
        peg$c19 = ",",
        peg$c20 = { type: "literal", value: ",", description: "\",\"" },
        peg$c21 = /^[\n\r\u2028\u2029]/,
        peg$c22 = { type: "class", value: "[\\n\\r\\u2028\\u2029]", description: "[\\n\\r\\u2028\\u2029]" },
        peg$c23 = { type: "other", description: "end of line" },
        peg$c24 = "\n",
        ...
        peg$c46 = { type: "other", description: "unquoted string" },
        peg$c47 = "-",
        ...
        peg$c71 = function(operator) {
              return {
                type:       "PostfixExpression",
                operator:   operator
              };
            },
        peg$c72 = function(operator, expression) {
              return {
        ...
        peg$c89 = function(id, operation, ref) {
        ...
        peg$c136 = function(element) {
            return element
          },
        peg$c137 = function(value) { return value; },
        peg$c138 = function(head, value) {
              var result = [ head ];
        ...
        peg$c182 = function(operator) { return operator; },
        peg$c183 = /^[ \xA0\u1680\u180E\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000]/,
    ...
    function peg$parseUnquotedStringLiteral() {
      ...
      if (s1 !== peg$FAILED) {
        s2 = [];
        s3 = peg$parseLiteralSequenceCharacters();
        if (s3 !== peg$FAILED) {
          while (s3 !== peg$FAILED) {
            s2.push(s3);
            s3 = peg$parseLiteralSequenceCharacters();
    ...
    function peg$parseIdentifierSeparators() {
      var s0;
    ...
    function peg$parseIdentifierPart() {
      ...
      s0 = peg$parseIdentifierSeparators();
      if (s0 === peg$FAILED) {
    ...
    function peg$parseIdentifierAliasExpression() {
      var s0, s1, s2, s3;
      ...
      if (s1 !== peg$FAILED) {
        ...
        if (s2 !== peg$FAILED) {
          ...
          if (s3 !== peg$FAILED) {
            s4 = peg$parse__();
            if (s4 !== peg$FAILED) {
              s5 = peg$parseIdentifierAliasExpression();
              if (s5 === peg$FAILED) {
                s5 = peg$c2;
              }
              if (s5 !== peg$FAILED) {
          ...
          if (s5 !== peg$FAILED) {
            ...
            if (s6 !== peg$FAILED) {
              ...
              if (s7 !== peg$FAILED) {
                s8 = peg$parse__();
                if (s8 !== peg$FAILED) {
                  s9 = peg$parseListElementsExpressions();
                  if (s9 !== peg$FAILED) {
                    peg$reportedPos = s3;
                    s4 = peg$c137(s9);
                    s3 = s4;
